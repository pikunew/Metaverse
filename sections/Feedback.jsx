    ...
    >
      ...
      >
        ...
        <p className="mt-[24px] font-normal sm:text-[18px] text-[18px] sm:leading-[45.6px] leading-[39.6px] text-gray-700">
          “The trust is formed by Mrs. Amarpreet Kaur, who has been working for
          enhancing the way women are treated at their workplace. Right from the
          year 2010, when she started educating women on their work rights, she
          has counseled, trained, and mentored many women on their Work Rights.
          Whether it be maternity-related matters, equality, employment,
          medical, hygiene, discrimination, or sexual harassment, she has
          reached out to women across socioeconomic levels and across states,
          with the aim of making sure that their Voice is heard. ”
        </p>
      </motion.div>
      ...
      >
        ...
        <Link href="/amarpreet">
          <motion.div
            ...
            className="lg:block absolute -left-[10%] top-[3%]"
          >
            <img
              src="/stamp.png"
              alt="stamp"
