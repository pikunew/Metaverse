...
const termsOfSevice = () => {
  return (
    <>
    <section className={`${styles.paddings} mt-40 `}>
      <Navbar />
        ...
        <div className=" flex flex-col items-start ">
          ...
          <br />
          <p>
            This website is operated by HRhelpdesk Trust. Throughout the site,
            the terms “we”, “us” and “our” refer to HRhelpdesk Trust. HRhelpdesk
            Trust offers this website, including all information, tools and
            ...
            stated here. By visiting our site and/ or purchasing / and or
            donating something from/ to us, you engage in our “Service” and
          ...
          <h3 className=" font-bold text-lg">SECTION 1 – ONLINE TERMS</h3>
          <p>
            ...
            minor dependents to use this site. You may not use our services for
          ...
          <h3 className=" font-bold text-lg">SECTION 2 – GENERAL CONDITIONS</h3>
          <p>
            We reserve the right to refuse service to anyone for any reason at
            any time. You understand that your content{" "}
            ...
            <br />
            <br />
            <span className=" font-semibold">(a)</span> transmissions over
            various networks; and <span className=" font-semibold"> (b)</span>{" "}
          ...
          <h3 className=" font-bold text-lg">SECTION 7 – OPTIONAL TOOLS</h3>
          <p>
          ...
          <h3 className=" font-bold text-lg">SECTION 8 – THIRD-PARTY LINKS</h3>
          <p>
          ...
          <p>
            ...
            <span className=" font-semibold italic ">
              {" "}
              (for example contest entries)
            </span>{" "}
            or without a request from us you send creative ideas, suggestions,
            ...
            obligation <span className=" font-semibold italic ">(1)</span> to
            maintain any comments in confidence;
            <span className=" font-semibold italic "> (2)</span> to pay
            compensation for any comments; or{" "}
            <span className=" font-semibold italic ">(3)</span> to respond to
            any comments. We may, but have no obligation to, monitor, edit or
          ...
          <h3 className=" font-bold text-lg">SECTION 12 – PROHIBITED USES</h3>
          <p>
            In addition to other prohibitions as set forth in the Terms of
            Service, you are prohibited from using the site or its content:{" "}
            <span className=" font-bold">(a)</span> for any unlawful purpose;{" "}
            <span className=" font-bold">(b)</span> to solicit others to perform
            or participate in any unlawful acts;
            <span className=" font-bold"> (c)</span> to violate any
            international, federal, provincial or state regulations, rules,
            laws, or local ordinances; <span className=" font-bold">(d)</span>{" "}
            to infringe upon or violate our intellectual property rights or the
            intellectual property rights of others;
            <span className=" font-bold"> (e)</span> to harass, abuse, insult,
            ...
            <span className=" font-bold">(f)</span> to submit false or
            misleading information; <span className=" font-bold">(g)</span> to
            ...
            or the Internet; <span className=" font-bold">(h) </span>to collect
            or track the personal information of others;
            <span className=" font-bold"> (i)</span> to spam, phish, pharm,
            pretext, spider, crawl, or scrape;
            <span className=" font-bold"> (j) </span>for any obscene or immoral
            purpose; or <span className=" font-bold">(k)</span> to interfere
          ...
          <p>
            ...
            you through the service are
            <span className=" font-bold">
              (except as expressly stated by us)
            </span>{" "}
            ...
            HRhelpdesk Trust, our Trustees, officers, employees, Volunteers,
            ...
            <span className=" font-bold"> (including negligence)</span>, strict
            ...
            the use of the service or any content
            <span className=" font-bold"> (or product)</span> posted,
          ...
          <h3 className=" font-bold text-lg">SECTION 14 – INDEMNIFICATION</h3>
          <p>
            You agree to indemnify, defend and hold harmless HRhelpdesk Trust
            and our parent, subsidiaries, affiliates, partners, officers,
            directors, Trustees, Volunteers, agents, contractors, licensors,
          ...
          <br />
          <br />
          <h3 className=" font-bold text-lg">SECTION 15 – SEVERABILITY</h3>
          <p>
          ...
          <br />
          <br />
          <h3 className=" font-bold text-lg">SECTION 16 – TERMINATION</h3>
          <p>
            ...
            <span className=" font-bold">(or any part thereof)</span>.
          </p>
          <br />
          <br />
          <h3 className=" font-bold text-lg">SECTION 17 – ENTIRE AGREEMENT</h3>
          <p>
          ...
          <br />
          <br />
          <h3 className=" font-bold text-lg">SECTION 18 – GOVERNING LAW</h3>
          <p>
          ...
          <br />
          <br />
          <h3 className=" font-bold text-lg">SECTION 19 – CHANGES</h3>
          <p>
            TO TERMS OF SERVICE You can review the most current version of the
