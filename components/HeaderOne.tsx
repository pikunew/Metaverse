    ...
    <div className="mt-28" ref={hero}>
      <div className=" lg:flex-row  lg:pt-0 lg:pr-8 lg:pb-20 lg:pl-14 lg:justify-around lg:items-center lg:gap-2 lg:min-h-[90vh] p-0 flex flex-col-reverse justify-between align-middle gap-6 min-h-full bg-primary-black  overflow-hidden">
        <div className=" xl:w-[35vw] lg:w-[40vw] lg:pt-48 sm:px-16 sm:flex-col sm:text-center pb-16 pt-2 px-6">
          ...
          Women have to struggle for some of the basic tenants of living. Whether it be as basic as awareness or whether it be as basic as prioritizing their own life over that of others. <br/>Amarpreet started working on making women aware of a simple aspect, that is their work rights at the workplace, her belief was that if women can be financially independent, they can do things or activities which have them at the centre, her intention was for Women to consider them also as individuals rather than machines designed to support others existence.<br/>Over the years, Amarpreet started realizing that the concept of being human isn't easily understood by both women and the society, hence the journey started of making women aware of their rights, preparing them to handle the world and presenting the world with reality check by doing many data-based studies on how women are treated.<br/>In March 2018, a legal shape was given to this initiative, and an NGO was launched, primarily to ensure that the dream which Amarpreet has is accomplished.<br/> We work in ensuring Dignified and Equal work rights for Women.
