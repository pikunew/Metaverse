    ...
    >
      ...
      >
            ...
            <div className=' absolute flex flex-col justify-center text-center'>
                <motion.div variants={fadeIn('up', 'tween', 0.5, 1)} className=' flex flex-col sm:flex-row gap-5 md:gap-24 xl:gap-32 pt-28 '>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <img src="/4.png" alt="map" className="w-full h-full object-cover relative flex flex-col justify-center text-center" />
                        </div>
                     ...
                     <div className='flex flex-col'>
                        ...
                        <img src="/5.png" alt="map" className="w-full h-full object-cover relative flex flex-col justify-center text-center" />
                        </div>
                        <p className='mt-8 font-bold text-2xl'>Point One</p>
                    </div>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <img src="/6.png" alt="map" className="w-full h-full  object-cover relative flex flex-col justify-center text-center" />
                        </div>
                        <p className='mt-8 font-bold text-2xl'>Point One</p>
                    </div>
